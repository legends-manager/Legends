...
export const card = { background: "#13251A", border: "1px solid rgba(88,124,99,0.35)" };
export const amber = { background: "#FFC53D", color: "#1A1607" };

export const Eyebrow = ({ children }) => (
  <div className="uppercase tracking-widest text-xs font-semibold" style={{ color: "#93AF9B" }}>
    {children}
  </div>
);
